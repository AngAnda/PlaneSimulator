...
float planeVertices[] = {
	10.0f, -0.5f,  10.0f,  4.0f, 0.0f,   // Top Right of the plane
   -10.0f, -0.5f,  10.0f,  0.0f, 0.0f,   // Top Left of the plane
   -10.0f, -0.5f, -10.0f,  0.0f, 4.0f,   // Bottom Left of the plane

	10.0f, -0.5f,  10.0f,  4.0f, 0.0f,   // Top Right of the plane
   -10.0f, -0.5f, -10.0f,  0.0f, 4.0f,   // Bottom Left of the plane
	10.0f, -0.5f, -10.0f,  4.0f, 4.0f    // Bottom Right of the plane
};
